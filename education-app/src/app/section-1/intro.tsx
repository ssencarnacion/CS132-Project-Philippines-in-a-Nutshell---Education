  ...
  return (
    <>
      <div className="mt-10 px-0 md:px-18 lg:px-36">
        ...
        <p className="text-black font-bold italic mix-blend-darken text-5-xl sm:text-5l md:text-5xl">This is</p>

        <p className="text-black font-bold italic m-1 text-center text-5xl sm:text-6xl md:text-8xl">ACCESS GRANTED</p>
