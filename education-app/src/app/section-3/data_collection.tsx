...
const Button_1 = ({ label, link }: { label: string, link: string }) => {
  return (
    <Link href={link}>
      <button
        className="p-2 bg-blue-700 text-white rounded cursor-pointer mx-1 text-sm hover:bg-indigo-800 w-60 h-20 text-xl"
      >
        {label}
      </button>
    </Link>
