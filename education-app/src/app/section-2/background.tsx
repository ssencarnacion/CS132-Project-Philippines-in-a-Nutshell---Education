    ...
    <>
      <div className="mt-10 pl-36 pr-36">
        ...
        <div className="flex mt-5">
          <div className="w-1/2 border border-black rounded-lg p-4 hover:bg-gray-300 transition duration-300">
          ...
          <div className="w-1/2 border border-black rounded-lg p-4 ml-4 hover:bg-gray-300 transition duration-300">
            ...
            <p className="text-justify mt-2">
              ...
              <span className="text-sky-500 font-bold">Alternative Hypothesis</span>: There are regional differences present in access to education.<br /><br />
            </p>
          </div>
        </div>
